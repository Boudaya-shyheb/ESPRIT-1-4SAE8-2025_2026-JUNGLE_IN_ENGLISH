...
The project follows a complete DevOps workflow for continuous integration, continuous delivery, containerization, orchestration, monitoring, testing, and security scanning.

### CI/CD Pipeline

The CI/CD pipeline is implemented using Jenkins to automate the application lifecycle from code integration to deployment.

Main pipeline stages:

1. Source code checkout
2. Maven build and dependency installation
...
| kubeadm | Kubernetes cluster initialization and orchestration |
| SonarQube | Static code quality and vulnerability analysis |
| JaCoCo | Java code coverage reporting |
| Mockito | Unit testing and mocking framework |
